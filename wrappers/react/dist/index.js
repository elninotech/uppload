(function webpackUniversalModuleDefinition(root, factory) {
	...
	else if (typeof define === "function" && define.amd) define("uppload-react", [], factory);
	else if (typeof exports === "object") exports["uppload-react"] = factory();
	else root["uppload-react"] = factory();
			...
			/***/ function(module, exports, __webpack_require__) {
				...
				function R(a, b, e, c) {
					...
					if (Array.isArray(a))
						...
						for (a = f.call(a), h = 0; !(d = a.next()).done; ) (d = d.value), (f = b + S(d, h++)), (g += R(d, f, e, c));
					else
						"object" === d &&
							((e = "" + a), C("31", "[object Object]" === e ? "object with keys {" + Object.keys(a).join(", ") + "}" : e, ""));
					return g;
				}
				function S(a, b) {
				...
				function U(a, b, e) {
					...
					Array.isArray(a)
						...
						: null != a &&
						  (M(a) &&
								((b = d + (!a.key || (b && b.key === a.key) ? "" : ("" + a.key).replace(N, "$\x26/") + "/") + e),
								(a = { $$typeof: t, type: a.type, key: b, ref: a.ref, props: a.props, _owner: a._owner })),
						  c.push(a));
				}
				...
				var W = {
						...
						isValidElement: M,
						version: "16.3.2",
						__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: { ReactCurrentOwner: I, assign: m }
					},
 ...
 */
		...
		`;
					 ...
					 */
					changePage(newPage) {
						if (window.globalStream && typeof window.globalStream.getTracks === "function")
							window.globalStream.getTracks()[0].stop();
			...
			/***/ function(module, __webpack_exports__, __webpack_require__) {
				...
				<div class="preview-container">
					...
					<div class="bottom-buttons">
						<div class="cta">
							<button class="primary-button secondary" id="backBtn">${__WEBPACK_IMPORTED_MODULE_5__icons__["a" /* default */].back} &nbsp;${
								i18n.preview.back
							}</button>
							<button class="primary-button" id="continueBtn">${i18n.preview.continue} &nbsp;${
								__WEBPACK_IMPORTED_MODULE_5__icons__["a" /* default */].forward
							}</button>
						</div>
					</div>
				</div>
            ...
            `,
				...
				<div class="camera-container">
					<div class="preview">
						<div id="cameraPermission"><div>${__WEBPACK_IMPORTED_MODULE_5__icons__["a" /* default */].error}</div><div>${
								i18n.camera.permission
							}</div></div>
						<div id="cameraError"><div>${__WEBPACK_IMPORTED_MODULE_5__icons__["a" /* default */].error}</div><div>${
								i18n.errors.camera_error
							}</div></div>
						<video id="cameraVideo">${i18n.errors.video_unavailable}</video>
						<canvas id="cameraCanvas"></canvas>
					</div>
					<div class="bottom-buttons">
						<div class="cta"><button class="primary-button" id="clickButton">${
							__WEBPACK_IMPORTED_MODULE_5__icons__["a" /* default */].camera
						} &nbsp;${i18n.camera.click}</button></div>
					</div>
				</div>
			`,
							init() {
        ...
        `
			...
			/***/ function(module, __webpack_exports__, __webpack_require__) {
				...
				/* harmony default export */ __webpack_exports__["a"] = scope => {
					if (!loaded) {
						scope.changePage("uploading");
						Object(__WEBPACK_IMPORTED_MODULE_0__loadFile__["a" /* default */])(
							"https://cdn.jsdelivr.net/npm/croppr@2.3.0/dist/croppr.min.js"
						)
							.then(() => {
								loaded = true;
