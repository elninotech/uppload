	...
	return (function(e) {
		...
		function(e, t, n) {
			...
			var o = Math.random()
				.toString(36)
				.slice(2);
			(t.default = { uniqueId: o, file: null }), (e.exports = t.default);
		},
		function(e, t, n) {
			"use strict";
			Object.defineProperty(t, "__esModule", { value: !0 }), (t.addGlobalEvent = void 0);
			var o,
				a = n(0);
			(o = a) && o.__esModule;
			var i = {};
			t.addGlobalEvent = function(e, t) {
				i[e] = t;
			};
		...
		function(e, t, n) {
			...
			function b(e, t) {
				...
				if (t.singleton) {
					var r = s++;
					(n = d || (d = g(t))), (o = E.bind(null, n, r, !1)), (a = E.bind(null, n, r, !0));
				} else
					e.sourceMap &&
					"function" == typeof URL &&
		...
		function(e, t, n) {
			...
			(t.default = function(e, t) {
				var n = function() {
						...
						t.showError(e), (0, a.default)("uploadError", e), (t.isUploading = !1);
					},
					i = document.querySelector("#uppload_" + o.default.uniqueId + " #instagramButton"),
					r = document.querySelector("#uppload_" + o.default.uniqueId + " #instagramInput");
				i.addEventListener("click", function(e) {
					t.changePage("uploading"),
						(t.isUploading = !0),
						(0, a.default)("uploadStarted"),
						setTimeout(function() {
							fetch("https://api.microlink.io/?url=" + r.value)
								.then(function(e) {
									return e.json();
								})
								.then(function(e) {
									"success" === e.status && e.data && e.data.image && e.data.image.url
										? ((0, a.default)("fileUploaded", e.data.image.url),
					...
					r.addEventListener("keyup", function(e) {
						e.preventDefault(), 13 === e.keyCode && i.click();
					});
			}),
				(e.exports = t.default);
		},
		function(e, t, n) {
			...
			(t.default = function(e) {
				var t = function() {
					...
					n = document.querySelector("#uppload_" + o.default.uniqueId + " #dragDropElement"),
					i = document.querySelector("#uppload_" + o.default.uniqueId + " #dragDropFileElt");
				n.addEventListener("drop", function(e) {
					e.dataTransfer.items
						? "file" === e.dataTransfer.items[0].kind &&
						  ((o.default.file = e.dataTransfer.items[0].getAsFile()),
						  t(),
						  (0, a.default)("fileDropped", o.default.file),
						  (0, a.default)("fileSelected", o.default.file))
						: ((o.default.file = e.dataTransfer.files[0]),
						  t(),
						  (0, a.default)("fileDropped", o.default.file),
						  (0, a.default)("fileSelected", o.default.file)),
						e.preventDefault();
					...
					n.addEventListener("dragenter", function(e) {
						n.classList.add("active"), (0, a.default)("dragEnter"), e.preventDefault();
					}),
					n.addEventListener("dragleave", function(e) {
						n.classList.remove("active"), (0, a.default)("dragLeave"), e.preventDefault();
					}),
					n.addEventListener("dragover", function(e) {
						(0, a.default)("dragOver"), e.preventDefault();
					}),
					n.addEventListener("click", function(e) {
						i.click(), e.preventDefault();
					}),
					document.querySelector("#uppload_" + o.default.uniqueId + " #selectFileBtn").addEventListener("click", function(e) {
						i.click(), e.preventDefault();
					}),
					i.addEventListener("change", function(e) {
						(o.default.file = i.files[0]), t(), (0, a.default)("fileSelected", o.default.file);
					});
			}),
				(e.exports = t.default);
		},
		...
		function(e, t, n) {
					...
					function e(t) {
						...
						!(function(e, t) {
							...
							(this.showError = function(e) {
								(0, l.default)("fileError", e),
									(document.querySelector("#uppload_" + i.default.uniqueId + " .errorMessage").innerHTML =
										"<strong>Error: </strong>" + e + "."),
									document.querySelector("#uppload_" + i.default.uniqueId + " .errorMessage").classList.add("visible"),
									setTimeout(function() {
										document.querySelector("#uppload_" + i.default.uniqueId + " .errorMessage").classList.remove("visible");
							...
							(this.uploadFile = function() {
								...
								return new Promise(function(t, o) {
									...
									if (!n.isFileSizeAllowed(e)) {
										var r = "File should be smaller than " + u(n.settings.maxFileSize);
										return n.showError(r), void o(r);
									}
									(n.isUploading = !0),
										n.changePage("uploading"),
										(0, l.default)("uploadStarted", e),
										setTimeout(function() {
											if ("function" == typeof n.settings.uploadFunction)
												n.settings
													.uploadFunction(e)
													.then(function(e) {
														n.updateValue(e), (0, l.default)("fileUploaded", e), t(e);
													})
													.catch(function(e) {
														(0, l.default)("uploadError", e), o(e);
													})
													.finally(function() {
												...
												"string" == typeof n.settings.endpoint && (n.settings.endpoint = { url: n.settings.endpoint }),
													fetch(n.settings.endpoint.url, {
														...
														.then(function(e) {
															(0, l.default)("fileUploaded", e), t(e);
														})
														.catch(function(e) {
															(0, l.default)("fileUploaded", e), o(e);
														})
														.finally(function() {
															(n.isUploading = !1), n.changePage("uploaded");
														});
							...
							(this.pages = (0, d.default)(this.uploadFile, this.settings.services, this)),
							(this.backgroundElement = document.createElement("div")),
							this.backgroundElement.classList.add("uppload-bg"),
							document.body.appendChild(this.backgroundElement),
							(this.modalElement = document.createElement("div")),
							this.modalElement.classList.add("uppload-modal"),
							this.modalElement.setAttribute("id", "uppload_" + i.default.uniqueId),
						...
						for (
							var a = document.querySelectorAll("#uppload_" + i.default.uniqueId + " .button_service"),
								s = function(e) {
									var t = a[e];
						...
						for (c = 0; c < this.settings.call.length; c++)
							for (var p = document.querySelectorAll(this.settings.call[c]), f = 0; f < p.length; f++)
								p[f].addEventListener("click", this.openModal.bind(this));
						this.on = function(e, t) {
							(0, r.addGlobalEvent)(e, t);
						};
					}
					return (
						a(e, [
							...
							},
							{
								...
								value: function(e) {
									if (this.pages[e]) {
										(document.querySelector("#uppload_" + i.default.uniqueId + " .currentPage").innerHTML = this.pages[e].html),
											"function" == typeof this.pages[e].init && this.pages[e].init(),
											(0, l.default)("pageChanged", e);
										for (
											var t = document.querySelectorAll("#uppload_" + i.default.uniqueId + " .button_service"), n = 0;
											n < t.length;
											n++
										)
											t[n].classList.remove("active");
										var o = document.querySelector("#uppload_" + i.default.uniqueId + " .button_service_" + e);
										o && o.classList.add("active");
										var a = document.querySelector("#uppload_" + i.default.uniqueId + " aside");
			...
			(window.Uppload = c), (t.default = c), (e.exports = t.default);
		}
	]);
});
